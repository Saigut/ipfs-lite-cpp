...
using sgns::codec::cbor::CborDecodeStream;
using sgns::codec::cbor::CborEncodeError;
using sgns::codec::cbor::CborEncodeStream;
using sgns::codec::cbor::CborResolveError;
using sgns::codec::cbor::decode;
using sgns::codec::cbor::encode;
...
TEST(Cbor, DecodeBlob) {
  using Blob3 = sgns::common::Blob<3>;
